...
null!=g.field(b,"start")?b.start(0):b.noteOn(0);null!=b.onended?b.onended=e(this,this._unlockCallback):w.delay(e(this,this._unlockCallback),1);this.resumeContext()}else a=window.document.createElement("audio"),b=window.document.createElement("source"),b.src="data:audio/wave;base64,UklGRjIAAABXQVZFZm10IBIAAAABAAEAQB8AAEAfAAABAAgAAABmYWN0BAAAAAAAAABkYXRhAAAAAA==",a.appendChild(b),window.document.appendChild(a),a.play(),null!=c.__touchUnlockCallback&&c.__touchUnlockCallback(),c.dom.ontouchend=null},
_unlockCallback:function(){null!=c.__touchUnlockCallback&&c.__touchUnlockCallback();c.dom.ontouchend=null},createAudioContext:function(){if(null==this.audioContext)try{null!=g.field(window,"AudioContext")?this.audioContext=new AudioContext:null!=g.field(window,"webkitAudioContext")&&(this.audioContext=new webkitAudioContext),this.masterGainNode=this.createGain()}catch(a){a instanceof u&&(a=a.val),this.audioContext=null}return this.audioContext},createGain:function(){return null!=this.audioContext.createGain?
this.audioContext.createGain():g.callMethod(this.audioContext,g.field(this.audioContext,"createGainNode"),[])},destroy:function(){null!=this.audioContext&&null!=this.audioContext.close&&""!=this.audioContext.close&&this.audioContext.close();this.types=this.bufferList=this.audioContext=null},suspendContext:function(){null!=this.audioContext&&null!=this.audioContext.state&&null!=this.audioContext.suspend&&this.audioContext.suspend()},resumeContext:function(){null!=this.audioContext&&null!=this.audioContext.state&&
null!=this.audioContext.resume&&this.audioContext.resume()},__class__:D};var v=function(a,b){this._b64=new n("(^data:audio).*(;base64,)","i");null!=a&&""!=a&&null!=c.audioManager&&(this.isSpriteSound=!1,this.url=a,this._muted=this._isPlaying=this._isLoaded=!1,this._duration=0,this._options=q.setDefaultOptions(b),this.rate=this._options.playbackRate)};v.__name__=!0;v.prototype={isReady:function(){return this._isLoaded},__class__:v};var n=function(a,b){b=b.split("u").join("");this.r=new RegExp(a,b)};
n.__name__=!0;n.prototype={match:function(a){this.r.global&&(this.r.lastIndex=0);this.r.m=this.r.exec(a);this.r.s=a;return null!=this.r.m},matched:function(a){if(null!=this.r.m&&0<=a&&a<this.r.m.length)return this.r.m[a];throw new u("EReg::matched");},__class__:n};var B=function(){};B.__name__=!0;B.prototype={__class__:B};var z=function(a,b,f){v.call(this,a,b);this._snd=c.dom.createElement("audio");null==f?this._addSource(a):this._snd.appendChild(f);this._options.preload&&this.load();this._b64.match(a)};
z.__name__=!0;z.__interfaces__=[B];z.__super__=v;z.prototype=m(v.prototype,{load:function(a){var b=this;this._isLoaded||(this._snd.autoplay=this._options.autoplay,this._snd.loop=this._options.loop,this._snd.volume=this._options.volume,this._snd.playbackRate=this.rate,null!=a&&(this._options.onload=a),this._snd.preload=this._options.preload?"auto":"metadata",null!=this._options.onload&&(this._isLoaded=!0,this._snd.onloadeddata=function(){b._options.onload(b)}),this._snd.onplaying=function(){b._isLoaded=
!0;b._isPlaying=!0},this._snd.onended=function(){b._isPlaying=!1;if(null!=b._options.onend)b._options.onend(b)},null!=this._options.onerror&&(this._snd.onerror=function(){b._options.onerror(b)}),this._snd.load());return this},getDuration:function(){return this._isLoaded?this._duration=this._snd.duration:0},_addSource:function(a){this.source=c.dom.createElement("source");this.source.src=a;var b=this._getExt(a);null!=c.audioManager.types.get(b)&&(a=this._getExt(a),this.source.type=c.audioManager.types.get(a));
...
this._snd&&this._isLoaded&&this._isPlaying?this._snd.currentTime:0},onEnd:function(a,b){this._options.onend=a;return this},onLoad:function(a){this._options.onload=a;return this},onError:function(a){this._options.onerror=a;return this},destroy:function(){null!=this._snd&&(this._snd.pause(),this._snd.removeChild(this.source),this._snd=this.source=null);this._isPlaying=!1},__class__:z});var x=function(){};x.__name__=!0;x.cca=function(a,b){a=a.charCodeAt(b);if(a==a)return a};x.indexOf=function(a,b,f){var c=
a.length;0>f&&(f+=c,0>f&&(f=0));for(;f<c;){if(a[f]===b)return f;f++}return-1};Math.__name__=!0;var g=function(){};g.__name__=!0;g.field=function(a,b){try{return a[b]}catch(f){return f instanceof u&&(f=f.val),null}};g.callMethod=function(a,b,f){return b.apply(a,f)};g.fields=function(a){var b=[];if(null!=a){var f=Object.prototype.hasOwnProperty,c;for(c in a)"__id__"!=c&&"hx__closures__"!=c&&f.call(a,c)&&b.push(c)}return b};var y=function(){};y.__name__=!0;y.string=function(a){return h.__string_rec(a,
"")};y.parseInt=function(a){var b=parseInt(a,10);0!=b||120!=x.cca(a,1)&&88!=x.cca(a,1)||(b=parseInt(a));return isNaN(b)?null:b};var c=l.Waud=function(){};c.__name__=!0;c.init=function(a){null==c.__audioElement&&(null==a&&(a=window.document),c.dom=a,c.__audioElement=c.dom.createElement("audio"),null==c.audioManager&&(c.audioManager=new D),c.isWebAudioSupported=c.audioManager.checkWebAudioAPISupport(),c.isHTML5AudioSupported=null!=g.field(window,"Audio"),c.isWebAudioSupported&&(c.audioContext=c.audioManager.createAudioContext()),
...
"color: #32BEA6; background: #29162B; padding:5px 0;","color: #999999; background: #29162B; padding:5px 0;","background: #32BEA6; padding:5px 0;","background: #B8FCEF; padding:5px 0;","background: #32BEA6; padding:5px 0;","color: #E70000; background: #32BEA6; padding:5px 0;","color: #FF2424; background: #FFFFFF; padding:5px 0;"]):window.console.log("WAUD.JS v"+c.version+" - "+a+" - http://www.waudjs.com")};c.autoMute=function(){c._focusManager=new r;c._focusManager.focus=function(){c.mute(!1);c.audioManager.resumeContext()};
c._focusManager.blur=function(){c.mute(!0);c.audioManager.suspendContext()}};c.enableTouchUnlock=function(a){c.__touchUnlockCallback=a;c.dom.ontouchend=(F=c.audioManager,e(F,F.unlockAudio))};c.setVolume=function(a){if(((a|0)===a||"number"==typeof a)&&0<=a&&1>=a){if(c._volume=a,null!=c.sounds)for(var b=c.sounds.iterator();b.hasNext();)b.next().setVolume(a)}else window.console.warn("Volume should be a number between 0 and 1. Received: "+a)};c.getVolume=function(){return c._volume};c.mute=function(a){null==
a&&(a=!0);c.isMuted=a;if(null!=c.sounds)for(var b=c.sounds.iterator();b.hasNext();)b.next().mute(a);a?c.audioManager.suspendContext():c.audioManager.resumeContext()};c.playbackRate=function(a){if(null==a)return c._playbackRate;if(null!=c.sounds)for(var b=c.sounds.iterator();b.hasNext();)b.next().playbackRate(a);return c._playbackRate=a};c.stop=function(){if(null!=c.sounds)for(var a=c.sounds.iterator();a.hasNext();)a.next().stop()};c.pause=function(){if(null!=c.sounds)for(var a=c.sounds.iterator();a.hasNext();)a.next().pause()};
...
this._srcNodes.push(b);this._gainNodes.push(this._gainNode);if(this._muted)this._setGain(0);else try{this._setGain(this._options.volume)}catch(f){f instanceof u&&(f=f.val)}return b},getDuration:function(){return this._isLoaded?this._duration:0},play:function(a,b){var c=this;this.spriteName=a;this._isPlaying&&this._options.autostop&&this.stop(this.spriteName);if(!this._isLoaded)return-1;var d=0,e=-1;this.isSpriteSound&&null!=b&&(this._currentSoundProps=b,d=b.start+this._pauseTime,e=b.duration);a=null!=
this._manager.bufferList?this._manager.bufferList.get(this.url):null;null!=a&&(this.source=this._makeSource(a),0<=d&&-1<e?this._start(0,d,e):(this._start(0,this._pauseTime,this.source.buffer.duration),this.source.loop=this._options.loop),this._playStartTime=this._manager.audioContext.currentTime,this._isPlaying=!0,this.source.onended=function(){c._isPlaying&&(c._pauseTime=0);c._isPlaying=!1;if(c.isSpriteSound&&null!=b&&null!=b.loop&&b.loop&&0<=d&&-1<e)c.destroy(),c.play(c.spriteName,b);else if(null!=
c._options.onend)c._options.onend(c)});return x.indexOf(this._srcNodes,this.source,0)},_start:function(a,b,c){null!=g.field(this.source,"start")?this.source.start(a,b,c):null!=g.field(this.source,"noteGrainOn")?g.callMethod(this.source,g.field(this.source,"noteGrainOn"),[a,b,c]):null!=g.field(this.source,"noteOn")&&g.callMethod(this.source,g.field(this.source,"noteOn"),[a,b,c])},_setGain:function(a){null!=this._gainNode.gain.setValueAtTime?this._gainNode.gain.setValueAtTime(a,this._manager.audioContext.currentTime):
this._gainNode.gain.value=a},togglePlay:function(a){this._isPlaying?this.pause():this.play()},isPlaying:function(a){return this._isPlaying},loop:function(a){this._options.loop=a;null!=this.source&&(this.source.loop=a)},setVolume:function(a,b){this._options.volume=a;null!=this._gainNode&&this._isLoaded&&!this._muted&&this._setGain(this._options.volume)},getVolume:function(a){return this._options.volume},mute:function(a,b){this._muted=a;null!=this._gainNode&&this._isLoaded&&(a?this._setGain(0):this._setGain(this._options.volume))},
toggleMute:function(a){this.mute(!this._muted)},autoStop:function(a){this._options.autostop=a},stop:function(a){this._pauseTime=0;null!=this.source&&this._isLoaded&&this._isPlaying&&this.destroy()},pause:function(a){null!=this.source&&this._isLoaded&&this._isPlaying&&(this.destroy(),this._pauseTime+=this._manager.audioContext.currentTime-this._playStartTime)},playbackRate:function(a,b){if(null==a)return this.rate;b=0;for(var c=this._srcNodes;b<c.length;){var d=c[b];++b;d.playbackRate.value=a}return this.rate=
...
b.length;){var c=b[a];++a;null!=g.field(c,"stop")?c.stop(0):null!=g.field(c,"noteOff")&&g.callMethod(c,g.field(c,"noteOff"),[0]);c.disconnect()}a=0;for(b=this._gainNodes;a<b.length;)c=b[a],++a,c.disconnect();this._srcNodes=[];this._gainNodes=[];this._isPlaying=!1},__class__:A});l=function(){};l.__name__=!0;var w=function(a){var b=this;this.id=setInterval(function(){b.run()},a)};w.__name__=!0;w.delay=function(a,b){var c=new w(b);c.run=function(){c.stop();a()};return c};w.prototype={stop:function(){null!=
this.id&&(clearInterval(this.id),this.id=null)},run:function(){},__class__:w};var E=function(a,b){this.map=a;this.keys=b;this.index=0;this.count=b.length};E.__name__=!0;E.prototype={hasNext:function(){return this.index<this.count},next:function(){return this.map.get(this.keys[this.index++])},__class__:E};var t=function(){this.h={}};t.__name__=!0;t.__interfaces__=[l];t.prototype={set:function(a,b){null!=H[a]?this.setReserved(a,b):this.h[a]=b},get:function(a){return null!=H[a]?this.getReserved(a):this.h[a]},
setReserved:function(a,b){null==this.rh&&(this.rh={});this.rh["$"+a]=b},getReserved:function(a){return null==this.rh?null:this.rh["$"+a]},arrayKeys:function(){var a=[],b;for(b in this.h)this.h.hasOwnProperty(b)&&a.push(b);if(null!=this.rh)for(b in this.rh)36==b.charCodeAt(0)&&a.push(b.substr(1));return a},iterator:function(){return new E(this,this.arrayKeys())},__class__:t};var u=function(a){Error.call(this);this.val=a;this.message=String(a);Error.captureStackTrace&&Error.captureStackTrace(this,u)};
u.__name__=!0;u.__super__=Error;u.prototype=m(Error.prototype,{__class__:u});var h=function(){};h.__name__=!0;h.getClass=function(a){if(a instanceof Array&&null==a.__enum__)return Array;var b=a.__class__;if(null!=b)return b;a=h.__nativeClassName(a);return null!=a?h.__resolveNativeClass(a):null};h.__string_rec=function(a,b){if(null==a)return"null";if(5<=b.length)return"<...>";var c=typeof a;"function"==c&&(a.__name__||a.__ename__)&&(c="object");switch(c){case "object":if(a instanceof Array){if(a.__enum__){if(2==
a.length)return a[0];c=a[0]+"(";b+="\t";for(var d=2,e=a.length;d<e;){var g=d++;c=2!=g?c+(","+h.__string_rec(a[g],b)):c+h.__string_rec(a[g],b)}return c+")"}c=a.length;d="[";b+="\t";for(e=0;e<c;)g=e++,d+=(0<g?",":"")+h.__string_rec(a[g],b);return d+"]"}try{d=a.toString}catch(G){return G instanceof u&&(G=G.val),"???"}if(null!=d&&d!=Object.toString&&"function"==typeof d&&(c=a.toString(),"[object Object]"!=c))return c;c=null;d="{\n";b+="\t";e=null!=a.hasOwnProperty;for(c in a)e&&!a.hasOwnProperty(c)||
"prototype"==c||"__class__"==c||"__super__"==c||"__interfaces__"==c||"__properties__"==c||(2!=d.length&&(d+=", \n"),d+=b+c+" : "+h.__string_rec(a[c],b));b=b.substring(1);return d+("\n"+b+"}");case "function":return"<function>";case "string":return a;default:return String(a)}};h.__interfLoop=function(a,b){if(null==a)return!1;if(a==b)return!0;var c=a.__interfaces__;if(null!=c)for(var d=0,e=c.length;d<e;){var g=d++;g=c[g];if(g==b||h.__interfLoop(g,b))return!0}return h.__interfLoop(a.__super__,b)};h.__instanceof=
function(a,b){if(null==b)return!1;switch(b){case L:return(a|0)===a;case I:return"number"==typeof a;case J:return"boolean"==typeof a;case String:return"string"==typeof a;case Array:return a instanceof Array&&null==a.__enum__;case M:return!0;default:if(null!=a)if("function"==typeof b){if(a instanceof b||h.__interfLoop(h.getClass(a),b))return!0}else{if("object"==typeof b&&h.__isNativeObj(b)&&a instanceof b)return!0}else return!1;return b==N&&null!=a.__name__||b==O&&null!=a.__ename__?!0:a.__enum__==b}};
h.__cast=function(a,b){if(h.__instanceof(a,b))return a;throw new u("Cannot cast "+y.string(a)+" to "+y.string(b));};h.__nativeClassName=function(a){a=h.__toStr.call(a).slice(8,-1);return"Object"==a||"Function"==a||"Math"==a||"JSON"==a?null:a};h.__isNativeObj=function(a){return null!=h.__nativeClassName(a)};h.__resolveNativeClass=function(a){return p[a]};var F,K=0;Array.prototype.indexOf&&(x.indexOf=function(a,b,c){return Array.prototype.indexOf.call(a,b,c)});String.prototype.__class__=String;String.__name__=
!0;Array.__name__=!0;Date.prototype.__class__=Date;Date.__name__=["Date"];var L={__name__:["Int"]},M={__name__:["Dynamic"]},I=Number;I.__name__=["Float"];var J=Boolean;J.__ename__=["Bool"];var N={__name__:["Class"]},O={},H={};c.PROBABLY="probably";c.MAYBE="maybe";c.version="1.0.2";c.useWebAudio=!0;c.defaults={autoplay:!1,autostop:!0,loop:!1,preload:!0,webaudio:!0,volume:1,playbackRate:1};c.preferredSampleRate=44100;c.isMuted=!1;c._playbackRate=1;d.JSON_PER=.8;r.FOCUS_STATE="focus";r.BLUR_STATE="blur";
r.ON_FOCUS="onfocus";r.ON_BLUR="onblur";r.PAGE_SHOW="pageshow";r.PAGE_HIDE="pagehide";r.WINDOW="window";r.DOCUMENT="document";h.__toStr={}.toString})("undefined"!=typeof console?console:{log:function(){}},"undefined"!=typeof window?window:exports,"undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this);
