...
var Base64 = function() {
	...
	this._addButton("0.25",0,220,80,30,function() {
		_gthis.setSoundRate(_gthis._countdown,0.25);
	});
	this._addButton("0.5",80,220,80,30,function() {
		_gthis.setSoundRate(_gthis._countdown,0.5);
	});
	this._addButton("1",160,220,80,30,function() {
		_gthis.setSoundRate(_gthis._countdown,1);
	});
	this._addButton("1.5",240,220,80,30,function() {
		_gthis.setSoundRate(_gthis._countdown,1.5);
	});
	this._addButton("2",320,220,80,30,function() {
		_gthis.setSoundRate(_gthis._countdown,2);
	});
	this._addButton("4",400,220,80,30,function() {
		_gthis.setSoundRate(_gthis._countdown,4);
	});
...
Base64.prototype = $extend(pixi_plugins_app_Application.prototype,{
	...
	,setGlobalRate: function(rate) {
		...
		var tmp = Waud.playbackRate();
		this._globalRateLabel.text = "Global Playback Rate: " + tmp;
	}
	,setSoundRate: function(sound,rate) {
		sound.playbackRate(rate);
		var tmp = sound.playbackRate();
		this._countdownRateLabel.text = "Countdown Playback Rate: " + tmp;
	}
