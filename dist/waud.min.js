...
var BaseSound = function(url,options) {
	...
	if(Waud.audioManager == null) return;
...
Waud.init = function(d) {
	...
	if(Waud.isWebAudioSupported) Waud.audioManager.createAudioContext(); else if(!Waud.isAudioSupported) null;
...
WaudSound.prototype = {
	...
	,_init: function(src) {
		if(Waud.isWebAudioSupported) this._snd = new WebAudioAPISound(src,this._options); else if(Waud.isAudioSupported) this._snd = new HTML5Sound(src,this._options); else null;
	}
	,setVolume: function(val) {
