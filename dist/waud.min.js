...
this._snd.load());return this},getDuration:function(){return this._isLoaded?this._duration=this._snd.duration:0},_addSource:function(a){this.source=d.dom.createElement("source");this.source.src=a;var b=d.audioManager.types,c=this._getExt(a);null!=(null!=f[c]?b.getReserved(c):b.h[c])&&(b=d.audioManager.types,a=this._getExt(a),a=null!=f[a]?b.getReserved(a):b.h[a],this.source.type=a);this._snd.appendChild(this.source);return this.source},_getExt:function(a){return a.split(".").pop()},setVolume:function(a,
b){0<=a&&1>=a&&(this._options.volume=a);this._isLoaded&&(this._snd.volume=this._options.volume)},getVolume:function(a){return this._options.volume},mute:function(a,b){this._isLoaded&&(this._snd.muted=a,this._snd.volume=a?0:this._options.volume,p.isiOS()&&(a&&this.isPlaying()?(this._muted=!0,this._snd.pause()):this._muted&&(this._muted=!1,this._snd.play())))},toggleMute:function(a){this.mute(!this._muted)},play:function(a,b){var c=this;this.spriteName=a;if(!this._isLoaded||null==this._snd)return-1;
if(this._isPlaying)if(this._options.autostop)this.stop(this.spriteName);else{var d=g.__cast(this._snd.cloneNode(!0),HTMLAudioElement);v.delay(e(d,d.play),100)}if(this._muted)return-1;this.isSpriteSound&&null!=b&&(this._snd.currentTime=null==this._pauseTime?b.start:this._pauseTime,null!=this._tmr&&this._tmr.stop(),this._tmr=v.delay(function(){null!=b.loop&&b.loop?c.play(c.spriteName,b):c.stop(c.spriteName)},Math.ceil(1E3*b.duration)));v.delay((w=this._snd,e(w,w.play)),100);this._pauseTime=null;return 0},
togglePlay:function(a){this._isPlaying?this.pause():this.play()},isPlaying:function(a){return this._isPlaying},loop:function(a){this._isLoaded&&null!=this._snd&&(this._snd.loop=a)},autoStop:function(a){this._options.autostop=a},stop:function(a){this._isLoaded&&null!=this._snd&&(this._snd.currentTime=0,this._snd.pause(),this._isPlaying=!1,null!=this._tmr&&this._tmr.stop())},pause:function(a){this._isLoaded&&null!=this._snd&&(this._snd.pause(),this._pauseTime=this._snd.currentTime,this._isPlaying=!1,
null!=this._tmr&&this._tmr.stop())},playbackRate:function(a,b){return null==a?this.rate:this.rate=this._snd.playbackRate=a},setTime:function(a){!this._isLoaded||null==this._snd||a>this._snd.duration||(this._snd.currentTime=a)},getTime:function(){return null!=this._snd&&this._isLoaded&&this._isPlaying?this._snd.currentTime:0},onEnd:function(a,b){this._options.onend=a;return this},onLoad:function(a){this._options.onload=a;return this},onError:function(a){this._options.onerror=a;return this},destroy:function(){null!=
this._snd&&(this._snd.pause(),this._snd.removeChild(this.source),this._snd=this.source=null);this._isPlaying=!1},__class__:B});var E=function(){};E.__name__=!0;E.cca=function(a,b){var c=a.charCodeAt(b);return c!=c?void 0:c};Math.__name__=!0;var h=function(){};h.__name__=!0;h.field=function(a,b){try{return a[b]}catch(c){return null}};h.fields=function(a){var b=[];if(null!=a){var c=Object.prototype.hasOwnProperty,d;for(d in a)"__id__"!=d&&"hx__closures__"!=d&&c.call(a,d)&&b.push(d)}return b};var z=
function(){};z.__name__=!0;z.string=function(a){return g.__string_rec(a,"")};z.parseInt=function(a){var b=parseInt(a,10);0!=b||120!=E.cca(a,1)&&88!=E.cca(a,1)||(b=parseInt(a));return isNaN(b)?null:b};var d=D.Waud=function(){};d.__name__=!0;d.init=function(a){null==d.__audioElement&&(null==a&&(a=window.document),d.dom=a,d.__audioElement=d.dom.createElement("audio"),null==d.audioManager&&(d.audioManager=new G),d.isWebAudioSupported=d.audioManager.checkWebAudioAPISupport(),d.isHTML5AudioSupported=null!=
h.field(window,"Audio"),d.isWebAudioSupported&&(d.audioContext=d.audioManager.createAudioContext()),d.sounds=new t,d._volume=1,a=d.isWebAudioSupported?"Web Audio":"HTML5 Audio",1<window.navigator.userAgent.toLowerCase().indexOf("chrome")?window.console.log.apply(window.console,["\n %c %c %c WAUD%c.%cJS%c v"+d.version+" - "+a+" %c  %c http://www.waudjs.com %c %c %c \ud83d\udce2 \n\n","background: #32BEA6; padding:5px 0;","background: #32BEA6; padding:5px 0;","color: #E70000; background: #29162B; padding:5px 0;",
"color: #F3B607; background: #29162B; padding:5px 0;","color: #32BEA6; background: #29162B; padding:5px 0;","color: #999999; background: #29162B; padding:5px 0;","background: #32BEA6; padding:5px 0;","background: #B8FCEF; padding:5px 0;","background: #32BEA6; padding:5px 0;","color: #E70000; background: #32BEA6; padding:5px 0;","color: #FF2424; background: #FFFFFF; padding:5px 0;"]):window.console.log("WAUD.JS v"+d.version+" - "+a+" - http://www.waudjs.com"))};d._sayHello=function(){var a=d.isWebAudioSupported?
"Web Audio":"HTML5 Audio";1<window.navigator.userAgent.toLowerCase().indexOf("chrome")?window.console.log.apply(window.console,["\n %c %c %c WAUD%c.%cJS%c v"+d.version+" - "+a+" %c  %c http://www.waudjs.com %c %c %c \ud83d\udce2 \n\n","background: #32BEA6; padding:5px 0;","background: #32BEA6; padding:5px 0;","color: #E70000; background: #29162B; padding:5px 0;","color: #F3B607; background: #29162B; padding:5px 0;","color: #32BEA6; background: #29162B; padding:5px 0;","color: #999999; background: #29162B; padding:5px 0;",
"background: #32BEA6; padding:5px 0;","background: #B8FCEF; padding:5px 0;","background: #32BEA6; padding:5px 0;","color: #E70000; background: #32BEA6; padding:5px 0;","color: #FF2424; background: #FFFFFF; padding:5px 0;"]):window.console.log("WAUD.JS v"+d.version+" - "+a+" - http://www.waudjs.com")};d.autoMute=function(){d._focusManager=new r;d._focusManager.focus=function(){d.mute(!1)};d._focusManager.blur=function(){d.mute(!0)}};d.enableTouchUnlock=function(a){d.__touchUnlockCallback=a;d.dom.ontouchend=
(w=d.audioManager,e(w,w.unlockAudio))};d.setVolume=function(a){if(("number"==typeof a&&(a|0)===a||"number"==typeof a)&&0<=a&&1>=a){if(d._volume=a,null!=d.sounds)for(var b=d.sounds,b=new l(b,b.arrayKeys());b.hasNext();)b.next().setVolume(a)}else window.console.warn("Volume should be a number between 0 and 1. Received: "+a)};d.getVolume=function(){return d._volume};d.mute=function(a){null==a&&(a=!0);d.isMuted=a;if(null!=d.sounds)for(var b=d.sounds,b=new l(b,b.arrayKeys());b.hasNext();)b.next().mute(a)};
d.playbackRate=function(a){if(null==a)return d._playbackRate;if(null!=d.sounds)for(var b=d.sounds,b=new l(b,b.arrayKeys());b.hasNext();)b.next().playbackRate(a);return d._playbackRate=a};d.stop=function(){if(null!=d.sounds)for(var a=d.sounds,a=new l(a,a.arrayKeys());a.hasNext();)a.next().stop()};d.pause=function(){if(null!=d.sounds)for(var a=d.sounds,a=new l(a,a.arrayKeys());a.hasNext();)a.next().pause()};d.getFormatSupportString=function(){var a="OGG: "+d.__audioElement.canPlayType('audio/ogg; codecs="vorbis"'),
a=a+(", WAV: "+d.__audioElement.canPlayType('audio/wav; codecs="1"')),a=a+(", MP3: "+d.__audioElement.canPlayType("audio/mpeg;")),a=a+(", AAC: "+d.__audioElement.canPlayType("audio/aac;"));return a+=", M4A: "+d.__audioElement.canPlayType("audio/x-m4a;")};d.isSupported=function(){if(null==d.isWebAudioSupported||null==d.isHTML5AudioSupported)d.isWebAudioSupported=d.audioManager.checkWebAudioAPISupport(),d.isHTML5AudioSupported=null!=h.field(window,"Audio");return d.isWebAudioSupported?!0:d.isHTML5AudioSupported};
d.isOGGSupported=function(){var a=d.__audioElement.canPlayType('audio/ogg; codecs="vorbis"');return d.isHTML5AudioSupported&&null!=a?"probably"!=a?"maybe"==a:!0:!1};d.isWAVSupported=function(){var a=d.__audioElement.canPlayType('audio/wav; codecs="1"');return d.isHTML5AudioSupported&&null!=a?"probably"!=a?"maybe"==a:!0:!1};d.isMP3Supported=function(){var a=d.__audioElement.canPlayType("audio/mpeg;");return d.isHTML5AudioSupported&&null!=a?"probably"!=a?"maybe"==a:!0:!1};d.isAACSupported=function(){var a=
d.__audioElement.canPlayType("audio/aac;");return d.isHTML5AudioSupported&&null!=a?"probably"!=a?"maybe"==a:!0:!1};d.isM4ASupported=function(){var a=d.__audioElement.canPlayType("audio/x-m4a;");return d.isHTML5AudioSupported&&null!=a?"probably"!=a?"maybe"==a:!0:!1};d.getSampleRate=function(){return null!=d.audioContext?d.audioContext.sampleRate:0};d.destroy=function(){if(null!=d.sounds)for(var a=d.sounds,a=new l(a,a.arrayKeys());a.hasNext();)a.next().destroy();d.sounds=null;null!=d.audioManager&&
d.audioManager.destroy();d.audioManager=null;d.audioContext=null;d.__audioElement=null;null!=d._focusManager&&(d._focusManager.clearEvents(),d._focusManager.blur=null,d._focusManager.focus=null,d._focusManager=null)};var H=D.WaudBase64Pack=function(a,b,c,m,n,f){null==f&&(f=!1);null!=d.audioManager&&(this._sequentialLoad=f,0<a.indexOf(".json")&&(this.progress=0,this._options=p.setDefaultOptions(n),this._loadCount=this._soundCount=this._totalSize=0,this._onLoaded=b,this._onProgress=c,this._onError=
m,this._sounds=new t,this._loadBase64Json(a)))};H.__name__=!0;H.prototype={_loadBase64Json:function(a){var b=this,c=new k('"meta":.[0-9]*,[0-9]*.',"i"),d=new XMLHttpRequest;d.open("GET",a,!0);null!=this._onProgress&&(d.onprogress=function(a){if(c.match(d.responseText)&&0==b._totalSize){var f=JSON.parse("{"+c.matched(0)+"}");b._totalSize=f.meta[1]}b.progress=a.lengthComputable?a.loaded/a.total:a.loaded/b._totalSize;1<b.progress&&(b.progress=1);b._onProgress(.8*b.progress)});d.onreadystatechange=function(){if(4==
d.readyState&&200==d.status){var a=JSON.parse(d.responseText);b._soundsToLoad=new t;b._soundIds=[];for(var c=0,e=h.fields(a);c<e.length;){var g=e[c];++c;if("meta"!=g)if(a instanceof Array&&null==a.__enum__){b._soundIds.push(h.field(a,g).name);var l=b._soundsToLoad,k=h.field(a,g).name,g="data:"+z.string(h.field(a,g).mime)+";base64,"+z.string(h.field(a,g).data);null!=f[k]?l.setReserved(k,g):l.h[k]=g}else b._soundIds.push(g),l=b._soundsToLoad,k=h.field(a,g),null!=f[g]?l.setReserved(g,k):l.h[g]=k}b._soundCount=
b._soundIds.length;if(b._sequentialLoad)a=b._soundIds.shift(),b._createSound(a);else for(;0<b._soundIds.length;)a=b._soundIds.shift(),b._createSound(a)}};d.send(null)},_createSound:function(a){var b=this,c=this._soundsToLoad;new F(null!=f[a]?c.getReserved(a):c.h[a],{onload:function(c){var n=b._sounds;null!=f[a]?n.setReserved(a,c):n.h[a]=c;n=d.sounds;null!=f[a]?n.setReserved(a,c):n.h[a]=c;if(null!=b._options.onload)b._options.onload(c);b._checkProgress()},onerror:function(c){var d=b._sounds;null!=
f[a]?d.setReserved(a,null):d.h[a]=null;if(null!=b._options.onerror)b._options.onerror(c);b._checkProgress()&&null!=b._onError&&b._onError()},autoplay:this._options.autoplay,autostop:this._options.autostop,loop:this._options.loop,onend:this._options.onend,playbackRate:this._options.playbackRate,preload:this._options.preload,volume:this._options.volume,webaudio:this._options.webaudio})},_checkProgress:function(){this._loadCount++;null!=this._onProgress&&this._onProgress(.8+this._loadCount/this._soundCount*
.19999999999999996);if(this._loadCount==this._soundCount)return this._soundsToLoad=null,null!=this._onLoaded&&this._onLoaded(this._sounds),!0;this._sequentialLoad&&this._createSound(this._soundIds.shift());return!1},__class__:H};var r=D.WaudFocusManager=function(){var a=this;this._currentState=this._visibilityChange=this._hidden="";null!=h.field(window.document,"hidden")?(this._hidden="hidden",this._visibilityChange="visibilitychange"):null!=h.field(window.document,"mozHidden")?(this._hidden="mozHidden",
this._visibilityChange="mozvisibilitychange"):null!=h.field(window.document,"msHidden")?(this._hidden="msHidden",this._visibilityChange="msvisibilitychange"):null!=h.field(window.document,"webkitHidden")&&(this._hidden="webkitHidden",this._visibilityChange="webkitvisibilitychange");null!=h.field(window,"addEventListener")?(window.addEventListener("focus",e(this,this._focus)),window.addEventListener("blur",e(this,this._blur)),window.addEventListener("pageshow",e(this,this._focus)),window.addEventListener("pagehide",
e(this,this._blur)),document.addEventListener(this._visibilityChange,e(this,this._handleVisibilityChange))):null!=h.field(window,"attachEvent")?(window.attachEvent("onfocus",e(this,this._focus)),window.attachEvent("onblur",e(this,this._blur)),window.attachEvent("pageshow",e(this,this._focus)),window.attachEvent("pagehide",e(this,this._blur)),document.attachEvent(this._visibilityChange,e(this,this._handleVisibilityChange))):window.onload=function(){window.onfocus=e(a,a._focus);window.onblur=e(a,a._blur);
window.onpageshow=e(a,a._focus);window.onpagehide=e(a,a._blur)}};r.__name__=!0;r.prototype={_handleVisibilityChange:function(){null!=h.field(window.document,this._hidden)&&h.field(window.document,this._hidden)&&null!=this.blur?this.blur():null!=this.focus&&this.focus()},_focus:function(){"focus"!=this._currentState&&null!=this.focus&&this.focus();this._currentState="focus"},_blur:function(){"blur"!=this._currentState&&null!=this.blur&&this.blur();this._currentState="blur"},clearEvents:function(){null!=
h.field(window,"removeEventListener")?(window.removeEventListener("focus",e(this,this._focus)),window.removeEventListener("blur",e(this,this._blur)),window.removeEventListener("pageshow",e(this,this._focus)),window.removeEventListener("pagehide",e(this,this._blur)),window.removeEventListener(this._visibilityChange,e(this,this._handleVisibilityChange))):null!=h.field(window,"removeEvent")?(window.removeEvent("onfocus",e(this,this._focus)),window.removeEvent("onblur",e(this,this._blur)),window.removeEvent("pageshow",
e(this,this._focus)),window.removeEvent("pagehide",e(this,this._blur)),window.removeEvent(this._visibilityChange,e(this,this._handleVisibilityChange))):(window.onfocus=null,window.onblur=null,window.onpageshow=null,window.onpagehide=null)},__class__:r};var F=D.WaudSound=function(a,b){if(null!=d.audioManager)if(this.rate=1,this._options=b,0<a.indexOf(".json")?(this.isSpriteSound=!0,this._spriteDuration=0,this._spriteSounds=new t,this._spriteSoundEndCallbacks=new t,this._loadSpriteJson(a)):(this.isSpriteSound=
!1,this._init(a)),(new k("(^data:audio).*(;base64,)","i")).match(a)){var c=d.sounds,m="snd"+(new Date).getTime();null!=f[m]?c.setReserved(m,this):c.h[m]=this}else c=d.sounds,null!=f[a]?c.setReserved(a,this):c.h[a]=this};F.__name__=!0;F.__interfaces__=[y];F.prototype={_loadSpriteJson:function(a){var b=this,c=new XMLHttpRequest;c.open("GET",a,!0);c.onreadystatechange=function(){if(4==c.readyState&&200==c.status){b._spriteData=JSON.parse(c.responseText);var d=b._spriteData.src;if(-1<a.indexOf("/"))var f=
a.lastIndexOf("/")+1,d=a.substring(0,f)+d;b._init(d)}};c.send(null)},_init:function(a){var b=this;this.url=a;if(d.isWebAudioSupported&&d.useWebAudio&&(null==this._options||null==this._options.webaudio||this._options.webaudio))this.isSpriteSound?this._loadSpriteSound(this.url):this._snd=new C(this.url,this._options);else if(d.isHTML5AudioSupported)if(null!=this._spriteData&&null!=this._spriteData.sprite){var c=0,m=null!=this._options&&null!=this._options.onload?this._options.onload:null;null==this._options&&
(this._options={});this._options.onload=function(a){c+=1;c==b._spriteData.sprite.length&&null!=m&&m(a)};this._options.onerror=function(a){c+=1;c==b._spriteData.sprite.length&&null!=m&&m(a)};a=0;for(var n=this._spriteData.sprite;a<n.length;){var e=n[a];++a;var g=new B(this.url,this._options);g.isSpriteSound=!0;var e=e.name,h=this._spriteSounds;null!=f[e]?h.setReserved(e,g):h.h[e]=g}}else this._snd=new B(this.url,this._options)},getDuration:function(){return this.isSpriteSound?this._spriteDuration:
null==this._snd?0:this._snd.getDuration()},setVolume:function(a,b){if("number"==typeof a&&(a|0)===a||"number"==typeof a)if(this.isSpriteSound){var c;null!=b?(c=this._spriteSounds,c=null!=(null!=f[b]?c.getReserved(b):c.h[b])):c=!1;c&&(c=this._spriteSounds,(null!=f[b]?c.getReserved(b):c.h[b]).setVolume(a))}else null!=this._snd&&this._snd.setVolume(a);else window.console.warn("Volume should be a number between 0 and 1. Received: "+a)},getVolume:function(a){if(this.isSpriteSound){var b;null!=a?(b=this._spriteSounds,
b=null!=(null!=f[a]?b.getReserved(a):b.h[a])):b=!1;return b?(b=this._spriteSounds,(null!=f[a]?b.getReserved(a):b.h[a]).getVolume()):0}return null==this._snd?0:this._snd.getVolume()},mute:function(a,b){if(this.isSpriteSound){var c;null!=b?(c=this._spriteSounds,c=null!=(null!=f[b]?c.getReserved(b):c.h[b])):c=!1;if(c)c=this._spriteSounds,(null!=f[b]?c.getReserved(b):c.h[b]).mute(a);else for(c=this._spriteSounds,c=new l(c,c.arrayKeys());c.hasNext();)c.next().mute(a)}else null!=this._snd&&this._snd.mute(a)},
toggleMute:function(a){if(this.isSpriteSound){var b;null!=a?(b=this._spriteSounds,b=null!=(null!=f[a]?b.getReserved(a):b.h[a])):b=!1;if(b)b=this._spriteSounds,(null!=f[a]?b.getReserved(a):b.h[a]).toggleMute();else for(a=this._spriteSounds,a=new l(a,a.arrayKeys());a.hasNext();)a.next().toggleMute()}else null!=this._snd&&this._snd.toggleMute()},load:function(a){if(null==this._snd||this.isSpriteSound)return null;this._snd.load(a);return this},isReady:function(){if(this.isSpriteSound)for(var a=this._spriteSounds,
a=new l(a,a.arrayKeys());a.hasNext();)return a.next().isReady();return this._snd.isReady()},play:function(a,b){if(this.isSpriteSound)if(null!=a){for(var c=0,d=this._spriteData.sprite;c<d.length;){var e=d[c];++c;if(e.name==a){b=e;break}}if(null==b)return null;c=this._spriteSounds;if(null!=(null!=f[a]?c.getReserved(a):c.h[a]))return c=this._spriteSounds,(null!=f[a]?c.getReserved(a):c.h[a]).play(a,b)}else return null;return null==this._snd?null:this._snd.play(a,b)},togglePlay:function(a){if(this.isSpriteSound){var b;
null!=a?(b=this._spriteSounds,b=null!=(null!=f[a]?b.getReserved(a):b.h[a])):b=!1;b&&(b=this._spriteSounds,(null!=f[a]?b.getReserved(a):b.h[a]).togglePlay())}else null!=this._snd&&this._snd.togglePlay()},isPlaying:function(a){if(this.isSpriteSound){var b;null!=a?(b=this._spriteSounds,b=null!=(null!=f[a]?b.getReserved(a):b.h[a])):b=!1;return b?(b=this._spriteSounds,(null!=f[a]?b.getReserved(a):b.h[a]).isPlaying()):!1}return null==this._snd?!1:this._snd.isPlaying()},loop:function(a){null==this._snd||
this.isSpriteSound||this._snd.loop(a)},autoStop:function(a){null!=this._snd&&this._snd.autoStop(a)},stop:function(a){if(this.isSpriteSound){var b;null!=a?(b=this._spriteSounds,b=null!=(null!=f[a]?b.getReserved(a):b.h[a])):b=!1;if(b)b=this._spriteSounds,(null!=f[a]?b.getReserved(a):b.h[a]).stop();else for(a=this._spriteSounds,a=new l(a,a.arrayKeys());a.hasNext();)a.next().stop()}else null!=this._snd&&this._snd.stop()},pause:function(a){if(this.isSpriteSound){var b;null!=a?(b=this._spriteSounds,b=null!=
(null!=f[a]?b.getReserved(a):b.h[a])):b=!1;if(b)b=this._spriteSounds,(null!=f[a]?b.getReserved(a):b.h[a]).pause();else for(a=this._spriteSounds,a=new l(a,a.arrayKeys());a.hasNext();)a.next().pause()}else null!=this._snd&&this._snd.pause()},playbackRate:function(a,b){if(null!=a){if(this.isSpriteSound){var c;null!=b?(c=this._spriteSounds,c=null!=(null!=f[b]?c.getReserved(b):c.h[b])):c=!1;if(c)c=this._spriteSounds,(null!=f[b]?c.getReserved(b):c.h[b]).playbackRate(a);else for(c=this._spriteSounds,c=new l(c,
c.arrayKeys());c.hasNext();)c.next().playbackRate(a)}else null!=this._snd&&this._snd.playbackRate(a);return this.rate=a}return this.rate},setTime:function(a){null==this._snd||this.isSpriteSound||this._snd.setTime(a)},getTime:function(){return null==this._snd||this.isSpriteSound?0:this._snd.getTime()},onEnd:function(a,b){if(this.isSpriteSound){if(null!=b){var c=this._spriteSoundEndCallbacks;null!=f[b]?c.setReserved(b,a):c.h[b]=a}return this}return null!=this._snd?(this._snd.onEnd(a),this):null},onLoad:function(a){if(null==
this._snd||this.isSpriteSound)return null;this._snd.onLoad(a);return this},onError:function(a){if(null==this._snd||this.isSpriteSound)return null;this._snd.onError(a);return this},destroy:function(){if(this.isSpriteSound)for(var a=this._spriteSounds,a=new l(a,a.arrayKeys());a.hasNext();)a.next().destroy();else null!=this._snd&&(this._snd.destroy(),this._snd=null)},_loadSpriteSound:function(a){var b=new XMLHttpRequest;b.open("GET",a,!0);b.responseType="arraybuffer";b.onload=e(this,this._onSpriteSoundLoaded);
b.onerror=e(this,this._onSpriteSoundError);b.send()},_onSpriteSoundLoaded:function(a){d.audioManager.audioContext.decodeAudioData(a.target.response,e(this,this._decodeSuccess),e(this,this._onSpriteSoundError))},_onSpriteSoundError:function(){if(null!=this._options&&null!=this._options.onerror)this._options.onerror(this)},_decodeSuccess:function(a){if(null==a)this._onSpriteSoundError();else{var b=this.url,c=d.audioManager.bufferList;null!=f[b]?c.setReserved(b,a):c.h[b]=a;this._spriteDuration=a.duration;
if(null!=this._options&&null!=this._options.onload)this._options.onload(this);b=0;for(c=this._spriteData.sprite;b<c.length;){var m=c[b];++b;var g=new C(this.url,this._options,!0,a.duration);g.isSpriteSound=!0;var h=m.name,k=this._spriteSounds;null!=f[h]?k.setReserved(h,g):k.h[h]=g;g.onEnd(e(this,this._spriteOnEnd),m.name)}}},_spriteOnEnd:function(a){var b=a.spriteName,c=this._spriteSoundEndCallbacks;null!=(null!=f[b]?c.getReserved(b):c.h[b])&&(b=a.spriteName,c=this._spriteSoundEndCallbacks,(null!=
f[b]?c.getReserved(b):c.h[b])(a))},__class__:F};var p=D.WaudUtils=function(){};p.__name__=!0;p.isAndroid=function(a){null==a&&(a=window.navigator.userAgent);return(new k("Android","i")).match(a)};p.isiOS=function(a){null==a&&(a=window.navigator.userAgent);return(new k("(iPad|iPhone|iPod)","i")).match(a)};p.isWindowsPhone=function(a){null==a&&(a=window.navigator.userAgent);return(new k("(IEMobile|Windows Phone)","i")).match(a)};p.isFirefox=function(a){null==a&&(a=window.navigator.userAgent);return(new k("Firefox",
"i")).match(a)};p.isOpera=function(a){null==a&&(a=window.navigator.userAgent);return(new k("Opera","i")).match(a)?!0:null!=h.field(window,"opera")};p.isChrome=function(a){null==a&&(a=window.navigator.userAgent);return(new k("Chrome","i")).match(a)};p.isSafari=function(a){null==a&&(a=window.navigator.userAgent);return(new k("Safari","i")).match(a)};p.isMobile=function(a){null==a&&(a=window.navigator.userAgent);return(new k("(iPad|iPhone|iPod|Android|webOS|BlackBerry|Windows Phone|IEMobile)","i")).match(a)};
p.getiOSVersion=function(a){null==a&&(a=window.navigator.userAgent);var b=new k("[0-9_]+?[0-9_]+?[0-9_]+","i"),c=[];if(b.match(a)){a=b.matched(0).split("_");b=[];for(c=0;c<a.length;){var d=a[c];++c;b.push(z.parseInt(d))}c=b}return c};p.setDefaultOptions=function(a){null==a&&(a={});a.autoplay=null!=a.autoplay?a.autoplay:d.defaults.autoplay;a.autostop=null!=a.autostop?a.autostop:d.defaults.autostop;a.webaudio=null!=a.webaudio?a.webaudio:d.defaults.webaudio;a.preload=null!=a.preload?a.preload:d.defaults.preload;
a.loop=null!=a.loop?a.loop:d.defaults.loop;a.onload=null!=a.onload?a.onload:d.defaults.onload;a.onend=null!=a.onend?a.onend:d.defaults.onend;a.onerror=null!=a.onerror?a.onerror:d.defaults.onerror;if(null==a.volume||0>a.volume||1<a.volume)a.volume=d.defaults.volume;if(null==a.playbackRate||0>=a.playbackRate||4<=a.playbackRate)a.playbackRate=d.defaults.playbackRate;return a};var C=function(a,b,c,m){null==m&&(m=0);null==c&&(c=!1);x.call(this,a,b);this._pauseTime=this._playStartTime=0;this._srcNodes=
[];this._gainNodes=[];this._currentSoundProps=null;this._isLoaded=c;this._duration=m;this._manager=d.audioManager;this._b64.match(a)?(a=this._base64ToArrayBuffer(a),this._manager.audioContext.decodeAudioData(a,e(this,this._decodeSuccess),e(this,this._error))):this._options.preload&&!c&&this.load()};C.__name__=!0;C.__interfaces__=[y];C.__super__=x;C.prototype=K(x.prototype,{load:function(a){if(!this._isLoaded){var b=new XMLHttpRequest;b.open("GET",this.url,!0);b.responseType="arraybuffer";b.onload=
e(this,this._onSoundLoaded);b.onerror=e(this,this._error);b.send();null!=a&&(this._options.onload=a)}return this},_base64ToArrayBuffer:function(a){a=window.atob(a.split(",")[1]);for(var b=a.length,c=new L(new I(b)),d=0;d<b;){var e=d++;c[e]=E.cca(a,e)}return c.buffer},_onSoundLoaded:function(a){this._manager.audioContext.decodeAudioData(a.target.response,e(this,this._decodeSuccess),e(this,this._error))},_decodeAudio:function(a){this._manager.audioContext.decodeAudioData(a,e(this,this._decodeSuccess),
e(this,this._error))},_error:function(){if(null!=this._options.onerror)this._options.onerror(this)},_decodeSuccess:function(a){if(null==a)this._error();else{var b=this.url,c=this._manager.bufferList;null!=f[b]?c.setReserved(b,a):c.h[b]=a;this._isLoaded=!0;this._duration=a.duration;if(null!=this._options.onload)this._options.onload(this);this._options.autoplay&&this.play()}},_makeSource:function(a){var b=this._manager.audioContext.createBufferSource();b.buffer=a;this._gainNode=this._manager.createGain();
...
var d=0,e=-1;this.isSpriteSound&&null!=b&&(this._currentSoundProps=b,d=b.start+this._pauseTime,e=b.duration);var g;if(null!=this._manager.bufferList){g=this.url;var h=this._manager.bufferList;g=null!=f[g]?h.getReserved(g):h.h[g]}else g=null;null!=g&&(this.source=this._makeSource(g),0<=d&&-1<e?this._start(0,d,e):(this._start(0,this._pauseTime,this.source.buffer.duration),this.source.loop=this._options.loop),this._playStartTime=this._manager.audioContext.currentTime,this._isPlaying=!0,this.source.onended=
function(){c._pauseTime=0;c._isPlaying=!1;if(c.isSpriteSound&&null!=b&&null!=b.loop&&b.loop&&0<=d&&-1<e)c.destroy(),c.play(c.spriteName,b);else if(null!=c._options.onend)c._options.onend(c)});return this._srcNodes.indexOf(this.source)},_start:function(a,b,c){if(null!=h.field(this.source,"start"))this.source.start(a,b,c);else if(null!=h.field(this.source,"noteGrainOn")){var d=this.source;h.field(this.source,"noteGrainOn").apply(d,[a,b,c])}else null!=h.field(this.source,"noteOn")&&(d=this.source,h.field(this.source,
"noteOn").apply(d,[a,b,c]))},togglePlay:function(a){this._isPlaying?this.pause():this.play()},isPlaying:function(a){return this._isPlaying},loop:function(a){this._options.loop=a;null!=this.source&&(this.source.loop=a)},setVolume:function(a,b){this._options.volume=a;null!=this._gainNode&&this._isLoaded&&!this._muted&&(this._gainNode.gain.value=this._options.volume)},getVolume:function(a){return this._options.volume},mute:function(a,b){this._muted=a;null!=this._gainNode&&this._isLoaded&&(this._gainNode.gain.value=
