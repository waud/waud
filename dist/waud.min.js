...
g.callMethod(this.audioContext,g.field(this.audioContext,"createGainNode"),[])},destroy:function(){null!=this.audioContext&&null!=this.audioContext.close&&""!=this.audioContext.close&&this.audioContext.close();this.types=this.bufferList=this.audioContext=null},__class__:E};var v=function(a,b){this._b64=new n("(^data:audio).*(;base64,)","i");null!=a&&""!=a&&null!=c.audioManager&&(this.isSpriteSound=!1,this.url=a,this._muted=this._isPlaying=this._isLoaded=!1,this._duration=0,this._options=q.setDefaultOptions(b),
...
new n("[0-9_]+?[0-9_]+?[0-9_]+","i"),c=[];if(b.match(a)){a=b.matched(0).split("_");b=[];for(c=0;c<a.length;){var d=a[c];++c;b.push(y.parseInt(d))}c=b}return c};q.setDefaultOptions=function(a){null==a&&(a={});a.autoplay=null!=a.autoplay?a.autoplay:c.defaults.autoplay;a.autostop=null!=a.autostop?a.autostop:c.defaults.autostop;a.webaudio=null!=a.webaudio?a.webaudio:c.defaults.webaudio;a.preload=null!=a.preload?a.preload:c.defaults.preload;a.loop=null!=a.loop?a.loop:c.defaults.loop;a.onload=null!=a.onload?
a.onload:c.defaults.onload;a.onend=null!=a.onend?a.onend:c.defaults.onend;a.onerror=null!=a.onerror?a.onerror:c.defaults.onerror;if(null==a.volume||0>a.volume||1<a.volume)a.volume=c.defaults.volume;if(null==a.playbackRate||0>=a.playbackRate||4<=a.playbackRate)a.playbackRate=c.defaults.playbackRate;return a};var A=function(a,b,f,d){null==d&&(d=0);null==f&&(f=!1);v.call(this,a,b);this._pauseTime=this._playStartTime=0;this._srcNodes=[];this._gainNodes=[];this._currentSoundProps=null;this._isLoaded=f;
...
null;null!=a&&(this.source=this._makeSource(a),0<=d&&-1<e?this._start(0,d,e):(this._start(0,this._pauseTime,this.source.buffer.duration),this.source.loop=this._options.loop),this._playStartTime=this._manager.audioContext.currentTime,this._isPlaying=!0,this.source.onended=function(){c._isPlaying&&(c._pauseTime=0);c._isPlaying=!1;if(c.isSpriteSound&&null!=b&&null!=b.loop&&b.loop&&0<=d&&-1<e)c.destroy(),c.play(c.spriteName,b);else if(null!=c._options.onend)c._options.onend(c)});return x.indexOf(this._srcNodes,
...
b.length;)c=b[a],++a,c.disconnect();this._srcNodes=[];this._gainNodes=[];this._isPlaying=!1},__class__:A});l=function(){};l.__name__=!0;var w=function(a){var b=this;this.id=setInterval(function(){b.run()},a)};w.__name__=!0;w.delay=function(a,b){var c=new w(b);c.run=function(){c.stop();a()};return c};w.prototype={stop:function(){null!=this.id&&(clearInterval(this.id),this.id=null)},run:function(){},__class__:w};var F=function(a,b){this.map=a;this.keys=b;this.index=0;this.count=b.length};F.__name__=
...
[],b;for(b in this.h)this.h.hasOwnProperty(b)&&a.push(b);if(null!=this.rh)for(b in this.rh)36==b.charCodeAt(0)&&a.push(b.substr(1));return a},iterator:function(){return new F(this,this.arrayKeys())},__class__:t};var u=function(a){Error.call(this);this.val=a;this.message=String(a);Error.captureStackTrace&&Error.captureStackTrace(this,u)};u.__name__=!0;u.__super__=Error;u.prototype=m(Error.prototype,{__class__:u});var h=function(){};h.__name__=!0;h.getClass=function(a){if(a instanceof Array&&null==
a.__enum__)return Array;var b=a.__class__;if(null!=b)return b;a=h.__nativeClassName(a);return null!=a?h.__resolveNativeClass(a):null};h.__string_rec=function(a,b){if(null==a)return"null";if(5<=b.length)return"<...>";var c=typeof a;"function"==c&&(a.__name__||a.__ename__)&&(c="object");switch(c){case "object":if(a instanceof Array){if(a.__enum__){if(2==a.length)return a[0];c=a[0]+"(";b+="\t";for(var d=2,e=a.length;d<e;){var g=d++;c=2!=g?c+(","+h.__string_rec(a[g],b)):c+h.__string_rec(a[g],b)}return c+
")"}c=a.length;d="[";b+="\t";for(e=0;e<c;)g=e++,d+=(0<g?",":"")+h.__string_rec(a[g],b);return d+"]"}try{d=a.toString}catch(G){return G instanceof u&&(G=G.val),"???"}if(null!=d&&d!=Object.toString&&"function"==typeof d&&(c=a.toString(),"[object Object]"!=c))return c;c=null;d="{\n";b+="\t";e=null!=a.hasOwnProperty;for(c in a)e&&!a.hasOwnProperty(c)||"prototype"==c||"__class__"==c||"__super__"==c||"__interfaces__"==c||"__properties__"==c||(2!=d.length&&(d+=", \n"),d+=b+c+" : "+h.__string_rec(a[c],b));
b=b.substring(1);return d+("\n"+b+"}");case "function":return"<function>";case "string":return a;default:return String(a)}};h.__interfLoop=function(a,b){if(null==a)return!1;if(a==b)return!0;var c=a.__interfaces__;if(null!=c)for(var d=0,e=c.length;d<e;){var g=d++;g=c[g];if(g==b||h.__interfLoop(g,b))return!0}return h.__interfLoop(a.__super__,b)};h.__instanceof=function(a,b){if(null==b)return!1;switch(b){case L:return(a|0)===a;case I:return"number"==typeof a;case J:return"boolean"==typeof a;case String:return"string"==
...
-1);return"Object"==a||"Function"==a||"Math"==a||"JSON"==a?null:a};h.__isNativeObj=function(a){return null!=h.__nativeClassName(a)};h.__resolveNativeClass=function(a){return p[a]};var B,K=0;Array.prototype.indexOf&&(x.indexOf=function(a,b,c){return Array.prototype.indexOf.call(a,b,c)});String.prototype.__class__=String;String.__name__=!0;Array.__name__=!0;Date.prototype.__class__=Date;Date.__name__=["Date"];var L={__name__:["Int"]},M={__name__:["Dynamic"]},I=Number;I.__name__=["Float"];var J=Boolean;
J.__ename__=["Bool"];var N={__name__:["Class"]},O={},H={};c.PROBABLY="probably";c.MAYBE="maybe";c.version="0.9.15";c.useWebAudio=!0;c.defaults={autoplay:!1,autostop:!0,loop:!1,preload:!0,webaudio:!0,volume:1,playbackRate:1};c.preferredSampleRate=44100;c.isMuted=!1;c._playbackRate=1;d.JSON_PER=.8;r.FOCUS_STATE="focus";r.BLUR_STATE="blur";r.ON_FOCUS="onfocus";r.ON_BLUR="onblur";r.PAGE_SHOW="pageshow";r.PAGE_HIDE="pagehide";r.WINDOW="window";r.DOCUMENT="document";h.__toStr={}.toString})("undefined"!=
